...
public class SerialPortSettingActivity extends PreferenceActivity {
	...
	public static String parityvalue[] = new String[] { "n", "o", "e" };// nŒﬁ o∆Ê
																		// e≈º
	public static String flowcontrol[] =new String[]{"none","CRTSCTS","Xon/Xoff"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spinner_flowcontrol.setOnItemSelectedListener(new OnItemSelectedListener() {
			@Override
			public void onItemSelected(AdapterView<?> parent, View view,
					int position, long id) {
		...
		SetSelectValue(spinner_name, sp.getString("name", ""));
		SetSelectValue(spinner_baud, sp.getString("baudValues", ""));
		SetSelectValue(spinner_data, sp.getString("databits", ""));
		SetSelectValue(spinner_stop, sp.getString("stop", ""));
		SetSelectValue(spinner_check, sp.getString("parityvalue", ""));
	...
	private void SetSelectValue(Spinner spinner, Object valueStr) {
		for (int i = 0; i < spinner.getCount(); i++) {
			if (valueStr.equals(spinner.getItemAtPosition(i))) {
